...
import { ListInterface } from 'src/app/shared/model/kanban-board/list/list.model';
import { MovementIntf, Movement } from 'src/app/shared/model/kanban-board/card/movement';
import { Card, CardInterface } from 'src/app/shared/model/kanban-board/card/card.model';
...
export class ListComponent implements OnInit {
  ...
  addNewCard(status: number) {
    const card = new Card(this.cardCount++ + '', 'header' + this.cardCount, 'summary' + this.cardCount, 'sample desc', status);
