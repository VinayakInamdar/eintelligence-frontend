  ...
  settings = {
    ...
    columns: {
      ...
      local_transaction_shipping: {
        title: 'Local Transaction Shipping',
      ...
      res => {
        this.campaignService.GetGaConversionsAnalyticsReports(this.selectedCampId, this.startDate, this.endDate).subscribe(
          behaviorres => {
            ...
            var data = [{ name: 'September 2020', transactions: '0', transaction_revenue: '0', transaction_tax: '0', local_transaction_shipping: '0' },
            { name: 'August 2020', transactions: '0', transaction_revenue: '0', transaction_tax: '0', local_transaction_shipping: '0' }]
